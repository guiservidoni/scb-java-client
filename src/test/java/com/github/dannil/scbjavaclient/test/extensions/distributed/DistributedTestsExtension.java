...
public class DistributedTestsExtension implements BeforeAllCallback, ExecutionCondition {
...
//
////            LOGGER.debug("Machine {} should run test ({}) {}", (testNumber % numberOfMachines), testNumber,
////                    testClazz.getName());
//
